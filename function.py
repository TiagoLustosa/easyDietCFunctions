...
with open('C:/projects/easy_diet_cloud_functions/userrrr.json', 'r', encoding="utf8") as input_file:
...
for i in userDataJson:
    ...
    result = calculateDietFourMeals(i)
    user.append(result)
    with open('resultUserrrr.json', 'w', encoding='utf-8') as output_file:
